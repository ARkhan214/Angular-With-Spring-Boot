...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
            ...
            FilterChain filterChain                  // Chain of filters to execute) throws ServletException, IOException
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isValid(token, userDetails)) {
                ...
                UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(
                        ...
                        token,                               // Credentials (password) — null since already authenticated
...
//
//        // bypus JWT path
//        boolean skip = path.equals("/api/user/login")           // login
//                || path.equals("/api/user/")
//                || path.equals("/api/account/")
